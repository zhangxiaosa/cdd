...
echo 'declare namespace drl ="SRDMBkaRqinLxFePmgOZ";declare namespace eelaj ="IxjPuengUs";declare namespace jhcPU ="IxjPuengUs";declare namespace ShOOF ="SRDMBkaRqinLxFePmgOZ";//*[boolean(. ! head(.)/has-children())]' > query.xq
