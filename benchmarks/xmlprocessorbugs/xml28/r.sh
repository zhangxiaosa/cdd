...
echo 'declare namespace lHTYj ="p";declare namespace UJb ="FgJcUQmOJTXKVYWTVp";declare namespace NTlBt ="FgJcUQmOJTXKVYWTVp";declare namespace ek ="p";declare namespace eOaRD ="FgJcUQmOJTXKVYWTVp";declare namespace k ="CPSOKjJZXOKm";//*[(boolean(head(.)) and not(head(tail(reverse(. ! (last(),.,local-name())))) castable as xs:integer)) and not(boolean(subsequence(reverse(tail(. ! tail(subsequence(., 25)))), 20)))]' > query.xq
