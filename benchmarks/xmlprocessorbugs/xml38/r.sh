...
QUERY='declare namespace hOeC ="ehNePQkrYdfiSp";declare namespace uOARN ="rYyuJJTlb";declare namespace MTRM ="CQnF";declare namespace imn ="AUeKnDIMIWvg";declare namespace s ="YWPmpsyWWDhdrrbnrCDa";declare namespace CnNX ="senmVXwihCPOenxR";declare namespace y ="bvhaWsczC";declare namespace yQzO ="TjQVCS";declare namespace VcOnc ="azcIqeTaaO";declare namespace G ="vhgncQXSLMnsCH";declare namespace Shp ="ehNePQkrYdfiSp";//*[not(head(./child::Shp:W7/preceding::*)/has-children() != true())]'
