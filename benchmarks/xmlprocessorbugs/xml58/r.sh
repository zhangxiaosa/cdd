...
echo 'declare namespace ZF ="TqSgHhbHSwH";declare namespace jdYX ="CkRmpYRETdaWjNRGg";declare namespace qo ="TqSgHhbHSwH";declare namespace Av ="CkRmpYRETdaWjNRGg";//*[((not(. = <A>2</A>) and not(not((sum(@f2) > 78390.3750) != true()))) and boolean(@id >= -1879133140)) and not(boolean(avg(reverse(reverse(subsequence(count(@id), 82))))))]' > query.xq
