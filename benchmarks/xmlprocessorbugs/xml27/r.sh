...
QUERY='declare namespace pdzi ="SmzhNeORxqb";declare namespace OZ ="SmzhNeORxqb";declare namespace TK ="QqwUPIwDKcsFiKjv";declare namespace Q ="SmzhNeORxqb";//*[head(subsequence(boolean(has-children()), 11, 11)) or boolean(./self::Q:Z29[not(boolean(days-from-duration(@g12)))])]'
