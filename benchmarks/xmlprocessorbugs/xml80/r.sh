...
echo 'declare namespace BK ="ygsbwy";declare namespace eI ="YeUvpWcr";declare namespace y ="ygsbwy";declare namespace Jw ="CeDf";declare namespace B ="YeUvpWcr";declare namespace mxnXZ ="DCYLazMRbuKocpLr";declare namespace dm ="YKHFoFEyePzlEYCFRaf";declare namespace kT ="k";declare namespace roP ="lzleRgYxeNq";//*[boolean(subsequence(./parent::*/preceding-sibling::*, 51, 1)) or (not(reverse(.) = <A>2</A>) and head(boolean(has-children() ! reverse(reverse(.)))))]' > query.xq
...
java -cp "/data/m492zhan/review/icse24/artifact_evaluation/basex-dd8b4c9.jar" org.basex.BaseX -i input.xml query.xq > ${target}_raw_result.xml 2>&1
ret=$?
