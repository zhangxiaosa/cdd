...
echo 'declare namespace LMMqB ="oRrVno";declare namespace zr ="gxZrNAR";declare namespace o ="oRrVno";declare namespace kGARo ="gxZrNAR";declare namespace apk ="oRrVno";//*[has-children() != false() and not(boolean(count(subsequence(boolean(subsequence(./(/R10/E17/T21/V11/D6/C12/R15/U14)/o:F13[boolean(position())], 1)), 12, 18))))]' > query.xq
