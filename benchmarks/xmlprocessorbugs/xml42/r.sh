...
echo 'declare namespace csm ="lePHT";declare namespace PlCgP ="STjR";declare namespace lU ="lePHT";declare namespace jkMq ="qEFGeNdQPcgCEggxzNTE";declare namespace D ="STjR";declare namespace uGcK ="iYB";//*[(not(boolean(head(tail(subsequence(name(), 7))))) and boolean(./self::uGcK:M24[not(boolean(Y9/E17/E29))])) and not(boolean(count(subsequence(., 4, 11))))]' > query.xq
