...
echo 'declare namespace bdm ="fFwjiptgapVBUVuXhlMt";declare namespace jbG ="fFwjiptgapVBUVuXhlMt";declare namespace fdFO ="iZwxJgkAaYJ";declare namespace OgO ="fFwjiptgapVBUVuXhlMt";declare namespace bP ="iZwxJgkAaYJ";//*[boolean(.//*[boolean(head(head(.)))]/preceding::*)]//*/*[boolean(subsequence(./following::*, 42, 56)) and (not((((count(.) >= 1577747651) ! .) ! head(.)) and false()) and (boolean(count(.)) and boolean(boolean((./following::fdFO:X33 = ()) or true()))))]' > query.xq
