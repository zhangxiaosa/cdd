...
echo 'declare namespace W ="RyCwpjSEKC";declare namespace qxXg ="vyTbVojmu";declare namespace VapLx ="f";declare namespace vxndq ="dje";declare namespace B ="RyCwpjSEKC";declare namespace MzV ="uyLGsp";declare namespace i ="eeAXjtDzVhEElpouA";declare namespace Qmdnb ="y";declare namespace bR ="eAOBailke";//*[head(head(. ! (head(. ! .),position()))) castable as xs:integer]' > query.xq
