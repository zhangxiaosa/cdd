...
echo 'declare namespace OjQxy ="Dwa";declare namespace I ="neSUreiZUjM";declare namespace KXw ="atokS";declare namespace LBZ ="Dwa";declare namespace LBXW ="bbsOYIbfEq";declare namespace M ="neSUreiZUjM";declare namespace MtWW ="FwcYiGFroLMUpNsNbh";declare namespace A ="pYUuHHPCasJbTam";declare namespace qjq ="nSZviPLiTzBGPSWAuDiC";declare namespace bPaFc ="xuL";//*[not((head(./(/D2/B27/Y22/Y26/C15/O16)[reverse(. ! (node-name() castable as xs:double))])/has-children() != true()) or false())]' > query.xq
