...
echo 'declare namespace XL ="BdtWwGzHqjVVw";declare namespace yDu ="M";declare namespace Juc ="BdtWwGzHqjVVw";//*[(boolean(round(math:sin(math:cos(sum(count(.)))))) and not(boolean(E35))) and head(.)/has-children(.)]' > query.xq
