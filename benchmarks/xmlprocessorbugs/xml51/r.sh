...
echo 'declare namespace Ge ="NHPAdrRRvXezQ";declare namespace MTT ="HDohGP";declare namespace Ip ="HDohGP";declare namespace nOJD ="NHPAdrRRvXezQ";declare namespace Of ="whkyMSWhlyqWyW";//*[not(boolean(boolean(.//*/(/Q14/N11/O8/C10/I11/L6/E8))))]' > query.xq
