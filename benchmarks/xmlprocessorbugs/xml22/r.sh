...
echo 'declare namespace haIlW ="FK";declare namespace To ="FK";declare namespace jDrvx ="siOnytXBmPcmqDKvOpr";declare namespace Kzagd ="FK";//*[not((tail(subsequence(boolean(subsequence(V43, 63)), 18, 2)) ! (.,count(.))) castable as xs:double) and boolean(reverse(./self::jDrvx:X6[not(boolean(V43))]))]' > query.xq
