...
echo 'declare namespace t ="lyShYXgGaiPtTgJiN";declare namespace icW ="AzSRpHWSSWBvQRnFVOh";declare namespace NFV ="lyShYXgGaiPtTgJiN";declare namespace iWX ="cgFfMTZSsDgUrcxt";declare namespace owMr ="iUMAp";declare namespace BaG ="zKFTJvZEHrnVcsM";declare namespace SNV ="tzRIteiQMepYwIDOvz";//*[boolean(./self::*/parent::*[boolean(local-name())]) != true() or ((has-children(.) and boolean(count(reverse(node-name())))) and boolean(./preceding::*/descendant-or-self::SNV:K16))]' > query.xq
