...
echo 'declare namespace d ="cIkcXntRWGEKMde";declare namespace U ="cIkcXntRWGEKMde";declare namespace XpbP ="cIkcXntRWGEKMde";//d:W20[boolean(./*/*[boolean(.)])]/*[boolean(subsequence(./following-sibling::*, 31)) or boolean(reverse(.))]' > query.xq
