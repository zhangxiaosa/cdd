...
echo 'declare namespace SEQ ="uZjMkoToe";declare namespace PQ ="uZjMkoToe";declare namespace jfXJ ="uZjMkoToe";//*[has-children() and (boolean(upper-case(normalize-space(head(.)/local-name()))) and boolean(@id))]' > query.xq
