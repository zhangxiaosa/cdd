...
check_strings=(
    ...
    "font_info::get_tfont(font_size, int, int, int) (node.cpp:262)"
    "special_node::special_node(macro const&, int) (node.cpp:3827)"
    "do_special (input.cpp:5248)"
    "token::next() (input.cpp:2142)"
    "process_input_stack() (input.cpp:2778)"
    "process_input_file(char const*) (input.cpp:7149)"
    "main (input.cpp:7456)"
